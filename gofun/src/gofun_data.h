...
{
	static std::vector<GofunDirectoryEntryData>* getData();
...
private:
	static std::vector<GofunDesktopEntryData*>* parseDirectorydir(const QString& catdir);
	static GofunDirectoryEntryData* parseDirectoryInfo(const QString& file);
